...
conf.TIMINGS.time_in.present_target = 5;
...
conf.STIMULI.setup.img1.target_duration = 0.5;
conf.STIMULI.setup.img1.target_random_range = 0.5;
conf.STIMULI.setup.img1.size = 100;
conf.STIMULI.setup.img1.padding = 75;
...
conf.STIMULI.setup.success_img.size = conf.STIMULI.setup.img1.size;
conf.STIMULI.setup.error_img.size = conf.STIMULI.setup.img1.size;
